...
class Order(models.Model):
    time_id = models.DateTimeField(auto_now_add = True)
...
class Product(models.Model):  # наследуемся от класса Model
...
class ProductOrder(models.Model):
    ...
    category_id = models.ForeignKey(Order, on_delete = models.CASCADE)
